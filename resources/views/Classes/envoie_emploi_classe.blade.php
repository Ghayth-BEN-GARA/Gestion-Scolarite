...
<html lang = "en">
    <head>
        ...
        <title>Envoyer Un Emploi | Université Sesame</title>
    </head>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title text-blue">Emploi Du Temps</h4>
                                </div>
                            </div>
                        </div>
                        @if($classe != null)
                            <div class = "row">
                                <div class = "col-12">
                                    <div class = "card">
                                        <div class = "card-body">
                                            <h4 class = "header-title">Emploi Du Temps</h4>
                                            <p class = "text-muted font-14">
                                                Envoyer un e-mail aux étudiants de la classe nommée <b>{{$classe->getDesignationClasseAttribute()}}</b> et contient l'emploi du temps du semestre souhaité dans l'année universitaire <b>{{$classe->debut_annee_universitaire}} - {{$classe->fin_annee_universitaire}}</b> en saisissant le formulaire ci-dessus.
                                            </p>
                                            ...
                                            <form name = "f-form-envoyer-emploi-classe" id  = "f-form-envoyer-emploi-classe" method = "post" action = "{{url('/envoyer-emploi-classe')}}" enctype = "multipart/form-data" >
                                                ...
                                                <div class = "row mb-3">
                                                    <label for = "button" class = "col-1 col-form-label"></label>
                                                    <div class = "col-11">
