...
<html lang = "en">
    <head>
        ...
        <title>Classes | Université Sesame</title>
    </head>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title text-blue">Liste Des Classes</h4>
                                </div>
                            </div>
                        </div>
                        <div class = "row mb-2">
                            <div class = "col-sm-4">
                                <a href = "{{url('/add-classe')}}" class = "btn btn-primary btn-rounded mb-3">
                            ...
                            @endif
                            <livewire:liste-classes-livewire/>
                        </div>
                    </div>
                </div>
            </div>
