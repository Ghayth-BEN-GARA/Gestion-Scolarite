                                ...
                                <div class = "card">
                                    <div class = "card-body">
                                        ...
                                        <p class = "text-muted font-14">
                                            Modification de cette salle en ajoutant les nouvelles informations requises pour la salle choisie.
                                        </p>
                                                ...
                                                <div class = "col-lg-4">
                                                    <div class = "text-center">
                                                        ...
                                                        <p class = "text-muted mt-2">
                                                            Malheureusement, nous n'avons pas trouvé une salle avec cette identifiant. Veuillez vérifier l'identifiant et réessayer plus tard.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
