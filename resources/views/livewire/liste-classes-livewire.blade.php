<div>
                        ...
                        <div class = "card-body">
                            <div class = "dropdown card-widgets">
                                ...
                                <div class = "dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href = "{{url('/edit-classe?id_classe='.$data->getIdClasseAttribute())}}" class = "dropdown-item">
                                    ...
                                    <a href = "javascript:void(0)" class = "dropdown-item" onclick = "questionInviterEtudiants({{$data->getIdClasseAttribute()}})">
                            ...
                            <p class = "mb-1">
                                ...
                                <span class = "text-nowrap mb-2 d-inline-block">
                                    <i class = "mdi mdi-book-education-outline text-muted"></i>
                                    <b>{{$this->getNbrCoursClasse($data->getIdClasseAttribute())}}</b> Cours
                                </span>
                            </p>
    ...
    @else
        <div class = "d-flex p-2">
            <span class = "text-center mx-auto">Aucune classe actuellement trouvée.</span>
        </div>
    @endif
    <div class = "mt-3 mb-3">
