                                ...
                                <div class = "page-title-box">
                                    <div class = "page-title-right">
                                        <ol class = "breadcrumb m-0">
                                            ...
                                            <li class = "breadcrumb-item active">Liste Des Séances</li>
                                        </ol>    
                                    </div>
                                    <h4 class = "page-title text-blue">Liste Des Séances</h4>
                                </div>
                            </div>
                        </div>
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "card">
                                    <div class = "card-body">
                                        <div class = "row mb-2">
                                            <div class = "col-sm-4">
                                                <a href = "{{url('/add-seance')}}" class = "btn btn-primary mb-2">
                                        ...
                                        @endif
                                        <livewire:liste-seances-livewire/>
                                    </div>
                                </div>
                            </div>
                        </div>
