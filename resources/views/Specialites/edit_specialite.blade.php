...
<html lang = "en">
    <head>
        ...
        <title>Modifier Une Spécialité | Université Sesame</title>
    </head>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title text-blue">Modifier Une Spécialité</h4>
                                </div>
                            </div>
                        </div>
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "card">
                                    <div class = "card-body">
                                        ...
                                        @endif
                                        @if($specialite != null)
                                            <form name = "f-form-modifier-specialite" id  = "f-form-modifier-specialite" method = "post" action = "{{url('/modifier-specialite')}}">
                                                {{ csrf_field() }}
                                                <div class = "row">
                                                    <div class = "col-md-12">
                                                        <div class = "mb-3">
                                                            <label for = "nom_module" class = "form-label">Nom</label>
                                                            <input type = "text" class = "form-control" id = "nom_specialite" name = "nom_specialite" placeholder = "Saisissez le nom du spécialité.." value = "{{$specialite->getNomSpecialiteAttribute()}}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type = "hidden" name = "id_specialite" id = "id_specialite" value = "{{$specialite->getIdSpecialiteAttribute()}}">
                                                <div class = "text-end">
                                                ...
                                                <div class = "col-lg-4">
                                                    <div class = "text-center">
                                                        ...
                                                        <p class = "text-muted mt-2">
                                                            Malheureusement, nous n'avons pas trouvé une spécialité avec cette identifiant. Veuillez vérifier l'identifiant et réessayer plus tard.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
