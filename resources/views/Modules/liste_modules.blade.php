...
<html lang = "en">
    <head>
        ...
        <title>Modules | Université Sesame</title>
    </head>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title text-blue">Liste Des Modules</h4>
                                </div>
                            </div>
                        </div>
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "card">
                                    <div class = "card-body">
                                        <div class = "row mb-2">
                                            <div class = "col-sm-4">
                                                <a href = "{{url('/add-module')}}" class = "btn btn-primary mb-2">
                                        ...
                                        @endif
                                        <livewire:liste-modules-livewire/>
                                    </div>
                                </div>
                            </div>
                        </div>
