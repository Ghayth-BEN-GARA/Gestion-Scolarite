                                            ...
                                            <div class = "row">
                                                ...
                                                <div class = "col-md-6">
                                                    <div class = "mb-3">
                                                        ...
                                                        <input type = "text" class = "form-control" id = "coefficient" name = "coefficient" placeholder = "Saisissez le coefficient du module.." onKeyPress = "return (event.charCode>=46 && event.charCode<=57)" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class = "row">
