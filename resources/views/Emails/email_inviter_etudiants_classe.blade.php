...
<html lang = "en">
    <head>
        ...
        <title>Email D'effectuation À La Classe | Université Sesame</title>
    </head>
                    ...
                    <div style = "-webkit-box-flex: 1; -ms-flex: 1 1 auto; flex: 1 1 auto; padding: 1.5rem 1.5rem;">
                        <div style = "margin: -1.5rem 0 -1.5rem 250px; padding: 1.5rem 0 1.5rem 25px;">
                            <div style = "margin-top: 1.5rem !important;">
                                <h5 style = "margin-top: 0; margin-bottom: 0.75rem; font-weight: 500; line-height: 1.1; font-size: 0.9375rem; margin: 10px 0; font-weight: 700; font-size: 18px !important;">Classe d'étudiant !</h5>
                                ...
                                <p style = "margin-top: 0; margin-bottom: 1rem;">
                                    Nous sommes très heureux de vous informer que vous êtes dans une classe désignée par <b>{{$mailData['nom_classe']}}</b> dans l'année universitaire <b>{{$mailData['annee_universitaire']}}</b>.
                                </p>
                                <hr style = "margin: 1rem 0; color: inherit; background-color: currentColor; border: 0; opacity: 0.25; height: 1px;">
                                <p style = "margin-top: 0; margin-bottom: 1rem;">
