                    ...
                    <div style = "-webkit-box-flex: 1; -ms-flex: 1 1 auto; flex: 1 1 auto; padding: 1.5rem 1.5rem;">
                        <div style = "margin: -1.5rem 0 -1.5rem 250px; padding: 1.5rem 0 1.5rem 25px;">
                            <div style = "margin-top: 1.5rem !important;">
                                <h5 style = "margin-top: 0; margin-bottom: 0.75rem; font-weight: 500; line-height: 1.1; font-size: 0.9375rem; margin: 10px 0; font-weight: 700; font-size: 18px !important;">Paramètres d'accès !</h5>
                                ...
                                <ul>
                                    <li>
                                        <b> Adresse Du Plateforme : </b> <a href = "http://127.0.0.1:8000/" style = "text-decoration:none;">Gestion De Scolarité</a>
                                    </li>
                                    <li>
